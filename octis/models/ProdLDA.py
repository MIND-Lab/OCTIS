...
class ProdLDA(AVITM):
    def __init__(self, dataset, num_topics=10, activation='softplus', dropout=0.2, learn_priors=True, batch_size=64, lr=2e-3,
        ...
        super().__init__(dataset=dataset, num_topics=num_topics, model_type='prodLDA', activation=activation, dropout=dropout,
    ...
    def train_model(self, hyperparameters=None, top_words=10):
        return super().train_model(hyperparameters, top_words)
