...
opt_params["minimizer"] = dummy_minimize
opt_params["different_iteration"] = 3
opt_params["n_random_starts"] = 3
...
opt_params["save_path"] = "risultati/dummy_minimize/" 
...
res.save(name ="Result", path = "risultati/dummy_minimize/", parameters = stringa_parameters)

print( resource.getrusage(resource.RUSAGE_SELF).ru_maxrss, "Kbytes" )
